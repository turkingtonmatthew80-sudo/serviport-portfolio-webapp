...
export function PortalPreviewSection() {
  return (
    <section className="w-full flex flex-col justify-center py-6 md:py-10 px-4 md:px-6 bg-gray-50/50 min-h-[auto] lg:min-h-[90vh]">
      <motion.div 
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, margin: "-50px" }}
        transition={{ duration: 0.8 }}
        className="max-w-[1400px] w-full mx-auto bg-[#0b1a2e] rounded-2xl overflow-hidden shadow-2xl relative flex flex-col justify-center"
      >
        ...
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-1/2 p-4 md:p-6 lg:p-10 z-10 flex flex-col justify-center">
            <div className="inline-block px-2 py-1 bg-[#00A9CE] text-white font-bold tracking-wider text-[10px] mb-2 uppercase shadow-sm w-fit">
          ...
          <div className="lg:w-1/2 bg-slate-900 border-t lg:border-t-0 lg:border-l border-white/5 p-4 md:p-6 lg:p-8 flex flex-col justify-center relative">
             ...
             <div className="relative z-10">
               <h3 className="text-lg md:text-xl font-bold text-white mb-2">¿Eres nuevo en Serviport?</h3>
               ...
               <ul className="text-slate-300 space-y-1 md:space-y-2 mb-6 text-[10px] md:text-xs">
                 <li className="flex items-center gap-2">
                   <div className="w-1.5 h-1.5 bg-[#00A9CE] rounded-full shrink-0"></div> Perfiles para Navieras, Armadores y BCOs.
                 </li>
                 <li className="flex items-center gap-2">
                   <div className="w-1.5 h-1.5 bg-[#00A9CE] rounded-full shrink-0"></div> Solicitudes de Port Calls y Husbandry.
                 </li>
                 <li className="flex items-center gap-2">
                   <div className="w-1.5 h-1.5 bg-[#00A9CE] rounded-full shrink-0"></div> Coordinación con Agentes de Aduana y Transportistas.
                 </li>
               </ul>

               <Link to="/portal" className="group border-2 border-[#F7941D] text-[#F7941D] hover:text-white hover:bg-[#F7941D] px-4 md:px-6 py-2 rounded font-bold transition-colors flex items-center justify-center gap-2 text-center text-[10px] md:text-xs uppercase tracking-wider w-fit">
