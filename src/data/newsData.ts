export interface NewsArticle {
  id: string;
  title: string;
  category: "Noticia" | "Nota de Prensa" | "Aviso Operativo" | "Blog" | "Caso de Éxito";
  date: string;
  image: string;
  excerpt: string;
  content: string;
...
export const newsData: NewsArticle[] = [
  {
    ...
    title: "Más Allá de la Ejecución: El Valor Estratégico del Agenciamiento Portuario Moderno",
    category: "Blog",
    date: "Jun 4, 2026",
    image: "https://images.unsplash.com/photo-1542281286-9e0a16bb7366?auto=format&fit=crop&q=80&w=800",
    excerpt: "En las operaciones marítimas de hoy, cada hora cuenta. Cómo la planificación anticipada y las tecnologías predictivas están transformando las escalas en puerto.",
...
La verdadera eficiencia no se logra en aislamiento. Requiere una colaboración fluida entre la Autoridad Portuaria, el SENIAT, operadores logísticos y los Agentes. Serviport continúa liderando iniciativas para estandarizar procesos y adoptar ventanas de tiempo (berth windows) más precisas, asegurando que Venezuela se mantenga como un hub competitivo y confiable en la región.`,
  ...
  },
  {
    ...
    category: "Noticia",
    date: "Jun 2, 2026",
    image: "https://images.unsplash.com/photo-1559297292-0b2a75225e?auto=format&fit=crop&q=80&w=600",
    excerpt: "Detalles sobre las últimas actualizaciones normativas emitidas por el INEA para todas las embarcaciones que arriban a puertos venezolanos.",
...
Desde Serviport, nuestro departamento legal y operativo ya se ha adaptado a estas normativas, asegurando que todos los buques representados por nuestra agencia experimenten cero fricciones o demoras a su llegada a Puerto Cabello y La Guaira. Recomendamos a todos nuestros clientes armadores actualizar la documentación de a bordo de acuerdo con esta circular.`,
  ...
  },
  {
    ...
    title: "Serviport Lanza Nuevo Servicio de Consolidación LCL en Puerto Cabello",
    category: "Nota de Prensa",
    date: "Jun 1, 2026",
    image: "https://images.unsplash.com/photo-1586528116311-ad8ed7c663c0?auto=format&fit=crop&q=80&w=600",
    excerpt: "Expandimos nuestras capacidades de almacén para ofrecer consolidación y desconsolidación de carga a importadores medianos.",
...
El servicio, que comenzó sus operaciones formales esta mañana, ya cuenta con alianzas con importantes forwarders internacionales y promete revolucionar la cadena de frío, al incluir también zonas de baja temperatura para carga perecedera fraccionada.`
  },
  {
    ...
    excerpt: "Actualización sobre las condiciones climáticas y tiempos de espera de atraque en la terminal principal de contenedores.",
...
El equipo de operaciones de Serviport mantiene monitoreo continuo 24/7 y notificará cualquier cambio en este estatus a los clientes afectados directamente a través de Serviport OS.`,
  ...
  },
  {
    ...
    category: "Noticia",
    date: "May 25, 2026",
    image: "https://images.unsplash.com/photo-1586528116311-ad8ed7c80a74?auto=format&fit=crop&q=80&w=600",
    excerpt: "Una mirada en profundidad a las estadísticas de carga manejadas el pasado mes y proyecciones para el segundo semestre.",
...
Los modelos proyectivos integrados en Serviport OS indican que la temporada de aprovisionamiento de las industrias manufactureras para el cierre de año comenzará temprano. Advertimos a nuestros clientes planificar el fletamento y reservar posición en el Almacén General de Depósito (AGD) con al menos dos semanas de antelación para asegurar capacidad.`
  },
  {
    ...
    title: "Consolidación de Proveedores en la Marítima: ¿Impulso a la Eficiencia o Riesgo Operativo?",
    category: "Blog",
    date: "May 20, 2026",
    image: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?auto=format&fit=crop&q=80&w=600",
    excerpt: "Analizamos los pros y los contras de depender de un solo socio logístico en las cadenas de suministro modernas.",
...
La consolidación es, sin duda, un multiplicador de la eficiencia, siempre que el proveedor central (hub) posea activos reales y solvencia tecnológica frente a las contingencias del entorno.`,
  ...
  },
  {
    ...
    title: "Resultados Boutique: Cómo nuestra Alianza Estratégica Optimiza la Operación LCL",
    category: "Caso de Éxito",
    date: "May 15, 2026",
    image: "https://images.unsplash.com/photo-1605810230434-7631ac76ec81?auto=format&fit=crop&q=80&w=600",
    excerpt: "Un análisis detallado de la optimización del supply chain para un importador regional de autopartes.",
    content: `**El Reto:**
...
En los primeros tres meses de la alianza, el tiempo promedio entre la llegada del buque y la salida del transporte hacia la capital se redujo en un impresionante 45%. Los costos por "demurrage" de equipos se redujeron a cero, ya que los contenedores vacíos se retornaban de inmediato desde nuestro propio patio anexo, permitiendo al importador un ahorro financiero sustancial e incremental durante todo el 2026.`
  },
  {
    ...
    title: "Más allá del algoritmo: el irremplazable valor humano en la agencia portuaria",
    category: "Blog",
    date: "May 10, 2026",
    image: "https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&q=80&w=600",
    excerpt: "Cómo la Inteligencia Artificial de logística complementa pero nunca reemplazará el conocimiento tácito de nuestro Water Clerk.",
...
En Serviport no vemos la tecnología como automatización para sustituir a los humanos, sino como un 'Exo-Esqueleto' para empoderarlos. Los tableros del Yard Planner le ahorran el trabajo burocrático de rastrear posiciones para que use toda su inteligencia en lidiar creativa y velozmente con las imprecisiones incontrolables del mundo real del comercio exterior.`,
  ...
  },
  {
    ...
    excerpt: "Información sobre trabajos de infraestructura que podrían impactar mínimamente los tiempos de tránsito terrestre de sus contenedores.",
...
Mantenemos garantizada la seguridad e interconexión de todas las descargas originadas desde Puerto de La Guaira. Agradecemos su previsión en base a este comunicado.`,
  ...
  },
  {
    ...
    title: "Elevamos Capacidades de Soporte: Nuevos Estándares en Inspección de Bunkering",
    category: "Blog",
    date: "Apr 28, 2026",
    image: "https://images.unsplash.com/photo-1542281286-9e0a16bb7366?auto=format&fit=crop&q=80&w=600",
    excerpt: "La garantía en volumen y calidad de combustible es prioritaria para nuestros servicios de Husbandry a los armadores.",
...
Garantizamos ahora reportes inmediatos bajo la robusta aplicación Serviport OS, asegurando que todos nuestros clientes globales tengan control y constancia en PDF de que han consumido estrictamente la energía contratada durante su repostaje.`,
  ...
  },
  {
    ...
    title: "Con un Ojo en el Balón: Liderazgo y Trabajo en Equipo en Operaciones de Estiba",
    category: "Blog",
    date: "Apr 20, 2026",
    image: "https://images.unsplash.com/photo-1559297292-0b2a75225e?auto=format&fit=crop&q=80&w=600",
    excerpt: "Entrevista a Carlos Martínez, supervisor del patio de contenedores, sobre los desafíos logísticos diarios.",
...
Carlos prosigue con su turno con el chaleco naranja bien ceñido y el radiocomunicador alertando de la entrada de nuevos chasis FCL hacia el AGD exportación de Serviport, recordándonos que en todo gigante naviero hay una inmensa maquinaria humana.`,
  ...
  },
  {
    ...
    title: "Trabajo en Equipo Supera los Desafíos de Fletamento de Carga Proyecto",
    category: "Caso de Éxito",
    date: "Apr 10, 2026",
    image: "https://images.unsplash.com/photo-1493246507139-91e8fad9978e?auto=format&fit=crop&q=80&w=600",
    excerpt: "Descarga exitosa de componentes eólicos masivos a pesar de los obstáculos portuarios regionales.",
    content: `**El Desafío:**
